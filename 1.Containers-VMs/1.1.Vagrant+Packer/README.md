...
`boot_command` - команды для первичной настройки устанавливаемой системы(https://help.ubuntu.com/lts/installation-guide/s390x/apb.html).  
...
`end`  
Далее добавляем нужные рецепты.